---
name: on-strategy
description: Socio de pensamiento estratégico que co-construye con el usuario, paso a paso y una decisión a la vez, la estrategia de una empresa o unidad de negocio, usando los frameworks de Roger Martin (Strategy Choice Cascade, Winning Aspiration, Where to Play, How to Win, Must-Have Capabilities, Enabling Management Systems, Strategic Logic Flow, Strategic Choice Structuring Process, What Would Have To Be True) y de Michael Porter (Cinco Fuerzas, ventaja competitiva, cadena de valor, trade-offs, encaje, las cinco pruebas de una buena estrategia). Úsalo cuando el usuario quiera definir o rehacer la estrategia de su negocio; cuestionar si lo que tiene es estrategia o solo un plan; decidir dónde competir, a qué segmento apuntar o si entrar a un mercado; entender cómo va a ganar frente a un competidor que le está quitando terreno; analizar el atractivo de su industria o su posición competitiva; definir qué capacidades y sistemas necesita; o escribir el documento de estrategia. Aplica aunque no diga "estrategia" ni nombre ningún framework.
---
