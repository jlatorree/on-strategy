...
Un nodo por decisión. Antes de escribir uno, lee acá su contenido y sus criterios de calidad; son diez bloques cortos y solo necesitas el que estás escribiendo.

Un nodo se cierra cuando cumple lo que dice su bloque **y** el usuario lo decidió.

---

## `00-problema-a-resolver`
...
*Calidad:* las tres pruebas, en orden: factible, distintivo, defendible. Si el sistema falla alguna, el problema está arriba: marca `02-where-to-play-how-to-win` como `desactualizado` y vuelvan al corazón. Una capacidad que cualquier competidor podría listar igual no es una Must-Have Capability, es un requisito de mesa.
...
## `05-posibilidades-descartadas`

Un párrafo por posibilidad descartada: qué era, qué condición no se sostuvo, y qué prueba lo demostró.

*Calidad:* este nodo es el que hace que la estrategia sobreviva a la primera reunión difícil. Sin él, cada persona que llegue después va a proponer de nuevo la opción ya descartada y nadie va a poder decir por qué se descartó.
...
*Calidad:* cada supuesto tiene que ser falsable. "El mercado va a seguir creciendo" no lo es; "el mercado de X crece al menos 8% anual en 2026 y 2027, medido por [fuente]" sí. Cuando un supuesto se prueba falso, marca como `desactualizado` los nodos que dependían de él.

## `07-senales-de-cambio`
...
*Calidad:* cada señal se escribe como algo observable. La utilidad de este nodo es que alguien pueda mirarlo en dos años y decir si pasó o no pasó.

## `a1-strategic-logic-flow` (anexo)

El Strategic Logic Flow desarrollado: los siete elementos, con las Cinco Fuerzas dentro del atractivo estructural, y el análisis de cadena de valor si se hizo. Es el nodo que responde de dónde salió cada elección.

## `a2-posibilidades-wwhtbt` (anexo)
...
Los dos anexos no entran al memo, y por eso pueden tener toda la extensión que haga falta.
